...
effort = readRDS(paste0("output/predictions_",scale, "_","eff_days","_",data,"_", split_wc,".rds"))
...
ggsave(paste0("figures/effort_",scale, "_",data,"_", split_wc,".jpeg"), height = 7, width = 7)
