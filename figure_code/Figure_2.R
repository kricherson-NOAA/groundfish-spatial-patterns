...
ggsave(all_maps, file = paste0("figures/Fig2_cg_inertia_map_",scale, "_",data,"_", split_wc,".jpeg"), height=7, width=7)
...
ggsave(all_maps_ind, file = paste0("figures/Fig2_cg_inertia_map_ind_",scale, "_",data,"_", split_wc,".jpeg"), height=7, width=7)
