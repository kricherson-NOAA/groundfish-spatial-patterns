...
lat = readRDS(paste0("output/predictions_",scale, "_","lat","_",data,"_", split_wc,".rds"))
lat_ind = readRDS(paste0("output/predictions_",scale, "_","lat-ind","_",data,"_", split_wc,".rds"))
...
ggsave(paste0("figures/lat_",scale, "_",data,"_", split_wc,".jpeg"), height = 7, width = 7)